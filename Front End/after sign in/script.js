...
// api fetching for the information div

fetch("https://newsapi.org/v2/top-headlines?country=in&category=health&apiKey=b0639852040a49e28c5c3e4e338d9558").then(value =>{
  // console.log(value)
  return value.json()
}).then(data => {
  ...
  data.articles.forEach(news =>{
    ...
    // const markup = `<li>${news.title}</li>`
    console.log(document.querySelector(".apifetch"))
    document.querySelector(".apifetch").innerHTML = `<p>${news.title}</p>`
